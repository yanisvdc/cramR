...
test_that("fit_model_ml errors when formula is NULL", {
  ...
  expect_error(
    fit_model_ml(data = dummy_data, formula = NULL, caret_params = caret_params),
...
test_that("fit_model_ml errors when method is missing", {
  ...
  expect_error(
    fit_model_ml(data = dummy_data, formula = y ~ x, caret_params = caret_params),
...
test_that("fit_model_ml sets default trControl if not provided", {
  ...
  model <- fit_model_ml(data = dummy_data, formula = y ~ x, caret_params = caret_params)
