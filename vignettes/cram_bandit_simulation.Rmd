...
```{r contextual-example, eval=requireNamespace("contextual", quietly = TRUE), fig.alt="Cumulative regret curve over time for the selected policy"}
...
```{r contextual-estimates, eval=requireNamespace("contextual", quietly = TRUE), fig.alt = "First rows of simulation output estimates"}
if (requireNamespace("contextual", quietly = TRUE)) {
  head(sim$estimates)
}
```

```{r contextual-table, eval=requireNamespace("contextual", quietly = TRUE), fig.alt = "Table of results"}
if (requireNamespace("contextual", quietly = TRUE)) {
